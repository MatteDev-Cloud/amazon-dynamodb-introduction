...
let requests=[],broken=false,missing=false,nextAt=0;const now=Date.now();const meta={sid:'network',phase:'pixel',version:2,phaseStartedAt:now,phaseEndsAt:now+90000,canvasW:48,canvasH:27,cooldownMs:1500,roundMs:15000,pixelMs:90000,canvasHidden:false,canvasRevision:0,teamsRevealed:false,roundId:null,roundStartedAt:null,roundEndsAt:null,tapGraceMs:2000,expiresAt:Math.floor(now/1000)+86400,prompt:'Scrivete DDB',botsEnabled:false};
