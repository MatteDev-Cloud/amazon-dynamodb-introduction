...
- L'X-Ray espone parametri strutturali e capacità, mai i valori delle credenziali. `consumed.read` e `consumed.write` distinguono letture e scritture anche nelle transazioni; `table`/`gsi` mantengono il riepilogo compatto.
